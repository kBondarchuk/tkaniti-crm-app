<template>
  <div class="stat-cell graph" style="display: flex; flex-direction: column; position: relative">
    <CMChartBar :chart-data="chartdata" class="graph" :class="{ transparent: loading }" @legend="handleLegend" />
    <div
      v-if="loading"
...
<script>
import CMChartBar from "@/components/CMChartBar.vue";

export default {
  name: "CMStatisticsBarGraphCell",
